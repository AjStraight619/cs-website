        ...
        <div>
          <p className="font-roboto_condensed">
            ...
            <p className="mb-5">
              ...
              reading worth 5% of the final grade. Instructions to use ZyBooks
              are as follows:
            </p>
            <ul className="mb-5">
              <li>
              ...
              <li>
                Subscribe. A Subscription is $89 and lasts until May 2024. This
                is also covered under Equitable Access.
              </li>
            </ul>

            <h3 className="font-semibold">Programming Language Used:</h3>
            <p className="mb-5">
              C++ in CLion (CLion is free with your SDSU ID). Students must
              author original C++ code for all projects throughout this course.
              Student collaboration is encouraged to discuss programming
              strategies, but all work must be completed and submitted
              individually. Do not give access to your code to anyone.
            </p>
            ...
            <p className="mb-5">
              ...
              due has passed links will be closed. Late Assignments will be
              marked down 25% every day of delay.
              <ul className="mb-5">
                <li>1 Day Late -25%</li>
            ...
            <p className="mb-5">
              ...
              cannot leave and then return to the test room. Once a student
              leaves the test room, he/she may not work further on the exam. Do
              not seek assistance from other students during an exam, for doing
              so constitutes cheating. Instead, speak with the instructor. The
              date, time, and location of the midterms and final exam will be
              posted on Canvas.
            </p>
            <p className="mb-5">
              Unexcused absences on the day of an exam will result in the
              student receiving a 0 on the exam. No make-up exams will be given
              for unexcused absences from the exam. If the student has a prior
              known conflict on the date of the exam, please submit a request to
              reschedule to the instructor at least 5 days prior to the exam
              date. Rescheduling will be at the discretion of the instructor. If
              approved, the student may take the exam on an earlier date. If the
              student misses the exam due to an unforeseen circumstance, email
              the instructor to discuss options. Absence must be documented for
              rescheduling to be considered. If you need special accommodations
              for testing kindly contact the Student Ability Success Center
              ASAP:{' '}
            ...
            <p className="mb-5">
              ...
              integrity. Dishonesty, cheating, plagiarism, or knowingly
              furnishing false information to the college are regarded as
              particularly serious offenses. Cases of dishonesty will be handled
              by levying certain penalties. However, in flagrant cases, the
              penalty may be dismissal from the college after proper due process
              proceedings.
            </p>
            ...
            <p className="mb-5">
              ...
              contact Student Disability Services at (619) 594-6473. To avoid
              any delay in the receipt of your accommodations, you should
              contact Student Disability Services as soon as possible. Please
              note that accommodations are not retroactive, and that
              accommodations based upon disability cannot be provided until you
              have presented your instructor with an accommodation letter from
